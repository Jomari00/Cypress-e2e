describe('Project Admin', () =>{
    it('projectSidenav-passes', () =>{
        ...
        cy.wait(10000)
        cy.get('[data-cy="Gantt Chart"]').click({force:true})//Gantt Chart
        cy.wait(5000)
        cy.get('.cdk-overlay-backdrop').click()
        cy.get('[data-cy="sideNav-toggleBtn"] > .mat-button-wrapper > .text-cyan100').click()
        cy.get('.cdk-overlay-backdrop').click()
        cy.get('[data-cy="Drawings"]').click()//Drawings
        cy.wait(5000)
        //cy.get('.cdk-overlay-backdrop').click()
        ...
        cy.get('[data-cy="sideNav-toggleBtn"] > .mat-button-wrapper > .text-cyan100').click()
        cy.get('.cdk-overlay-backdrop').click()
        cy.get('[data-cy="sidebar-internalitems"] > :nth-child(5)').click()//Setup
    })
